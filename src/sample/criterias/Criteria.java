...
public class Criteria
{
	...
	{
		float p = (float)this.true_positives/(this.true_positives + this.false_positives);
	...
	{
		float r = (float)this.true_positives/(this.true_positives + this.false_negatives);
	...
	{
		int total = false_negatives + false_positives + true_negatives + true_positives;
